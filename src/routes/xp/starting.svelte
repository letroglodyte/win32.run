...
<div class="absolute inset-0 bg-black overflow-hidden text-slate-100">
    <div class="absolute top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] animate-fadein">
        <img src="/images/keysOS.png" alt="" width="600px">
        <div class="xp-loader">
            <div></div>
            <div></div>
            <div></div>
    ...
    <div class="absolute right-8 bottom-8 animate-fadein">
        <img src="/images/loading_logo.png" width="200px" alt="">
    </div>
...
<style>
    ...
    .xp-loader div{
        width: 9px;
        height: 100%;
        background: linear-gradient(to bottom, #85039c 0%,#9016c8 17%,#ac6eac 32%,#e06ce7 45%,#7d2b82 59%,#820196 100%);
